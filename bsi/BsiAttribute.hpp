...
public:
    ...
    */
    ...
    BsiAttribute<uword>* buildBsiAttributeFromTensor(torch::Tensor& nums, double compressThreshold) const;
...
private:
    ...
    std::vector< std::vector< uword > > bringTheBits(const torch::Tensor& nums, int slices, int attRows) const;
protected:
