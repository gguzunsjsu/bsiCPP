...
int main() {
    ...
    try {
        ...
        BsiAttribute<uint64_t>* bsi1 = ubsi.buildBsiAttributeFromVector(array1_long, compressionThreshold);
        BsiAttribute<uint64_t>* bsi2 = ubsi.buildBsiAttributeFromVector(array2_long, compressionThreshold);
