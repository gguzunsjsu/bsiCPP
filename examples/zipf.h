...
#ifndef BSIHYBRID_ZIPF_H
#define BSIHYBRID_ZIPF_H
 ...
 *
 * Implementation by and large taken from Lina's answer to
 ...
 *
 * @params max: is the maximum value range
 * @params s: zipf skew
 * @params q: Hurwicz q-deformation
 *
 * Example usage:
 *
...
public:
    ...
    /// Zipf distribution for `N` items, in the range `[1,N]` inclusive. Subtract 1 if range should start with 0;
