...
//    const int    MAX_SLICES           = 16;
    ...
    std::ofstream out("results_1M.csv");
...
//        ubsi.setMaxNumBitSlices(MAX_SLICES);
        ...
        for (int run = 0; run < RUNS; run++) {
            ...
            auto *bsiA = ubsi.buildBsiVectorFromVector(A_long, COMPRESSION_THRESHOLD);
            auto *bsiB = ubsi.buildBsiVectorFromVector(B_long, COMPRESSION_THRESHOLD);
